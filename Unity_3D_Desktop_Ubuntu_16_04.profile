...
[core]
s0_active_plugins = core;composite;opengl;imgjpeg;place;firepaint;imgpng;resize;regex;mousepoll;thumbnail;move;vpswitch;animation;compiztoolbox;annotate;grid;session;wobbly;workarounds;fade;cube;rotate;scale;showmouse;unitymtgrabhandles;td;cubeaddon;expo;ezoom;unityshell;
